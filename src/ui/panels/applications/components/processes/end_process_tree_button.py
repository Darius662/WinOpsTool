"""End Process Tree button component."""
from PyQt6.QtWidgets import QPushButton
from PyQt6.QtCore import pyqtSignal


class EndProcessTreeButton(QPushButton):
    """Button for ending a selected process and its children."""
    
    # Signal emitted when button is clicked
    clicked_with_selection = pyqtSignal()
    
    def __init__(self, parent=None):
        """Initialize the end process tree button.
        
        Args:
            parent: Parent widget
        """
        super().__init__("End Process Tree", parent)
