"""Uninstall button component for software panel."""
from PyQt6.QtWidgets import QPushButton
from PyQt6.QtCore import pyqtSignal


class UninstallButton(QPushButton):
    """Button for uninstalling software."""
    
    # Signal emitted when button is clicked
    clicked_with_filter = pyqtSignal(str)
    
    def __init__(self, filter_type="All", parent=None):
        """Initialize uninstall button.
        
        Args:
            filter_type: Current filter type
            parent: Parent widget
        """
        super().__init__("Uninstall", parent)
